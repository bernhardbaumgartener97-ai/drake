#!/usr/bin/env python3
"""Nearfield readiness adapter for the drake fork.

This fork-local adapter scores robot evaluation traces for the dynamics_and_contact
...
THRESHOLDS = {
    ...
    "max_jerk": 3.2,
    "max_saturation_ratio": 0.08,
    "max_calibration_rmse_px": 1.5,
    "max_contact_events": 2,
    "min_success_rate": 0.95,
    "min_stability_margin": 0.22
}
